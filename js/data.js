...
const DOMAINS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Optoelectronics", tools: [{ name: "Photocell / LDR", calc: "photocell-ldr" }, { name: "Optocoupler" }, { name: "LED forward voltage/current" }, { name: "Wavelength ↔ color/spectrum chart" }] },
    ],
  },
  {
    id: "digital",
