...
const DOMAINS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Optoelectronics", tools: [{ name: "Photocell / LDR", calc: "photocell-ldr" }, { name: "Optocoupler", calc: "optocoupler" }, { name: "Wavelength ↔ color/spectrum chart", calc: "spectrum-chart" }] },
    ],
  },
  {
    id: "digital",
    ...
    sections: [
      ...
      { title: "Sequential logic", tools: [{ name: "Flip-flops (SR, D, JK, T)", calc: "flip-flops" }, { name: "Multivibrators (astable/monostable)", calc: "multivibrator" }, { name: "555 Timer (astable/monostable)" }] },
      { title: "Number systems", tools: [{ name: "DEC / HEX / OCT / BIN conversion", calc: "dec-hex-bin" }, { name: "ASCII table", calc: "ascii-table" }] },
      {
        ...
        tools: [
          { name: "PWM (duty cycle)", calc: "pwm-duty" }, { name: "Debounce / RC timing", calc: "debounce-rc" }, { name: "I2C pull-up resistor" }, { name: "UART baud rate" },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Battery", tools: [{ name: "Runtime / capacity estimation", calc: "battery-runtime" }, { name: "C-rate", calc: "c-rate" }, { name: "Internal resistance" }, { name: "Battery types & sizes", calc: "battery-sizes" }, { name: "Button cells", calc: "button-cells" }, { name: "Accumulators" }] },
