...
const DOMAINS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Battery", tools: [{ name: "Runtime / capacity estimation", calc: "battery-runtime" }, { name: "C-rate", calc: "c-rate" }, { name: "Internal resistance" }, { name: "Battery types & sizes", calc: "battery-sizes" }, { name: "Button cells" }, { name: "Accumulators" }] },
