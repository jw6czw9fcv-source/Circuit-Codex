...
const DOMAINS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Optoelectronics", tools: [{ name: "Photocell / LDR", calc: "photocell-ldr" }, { name: "Optocoupler", calc: "optocoupler" }, { name: "LED forward voltage/current", calc: "led-forward" }, { name: "Wavelength ↔ color/spectrum chart" }] },
    ],
  },
  {
    id: "digital",
