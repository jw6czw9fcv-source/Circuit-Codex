...
const DOMAINS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Rectifiers", tools: [{ name: "Half-wave", calc: "rectifier-halfwave" }, { name: "Full-wave (bridge)", calc: "rectifier-bridge" }, { name: "Full-wave with center tap", calc: "rectifier-centertap" }, { name: "Half-wave with capacitor (ripple)" }] },
